$(document).ready(function() {
    ...
    saveText1.addEventListener('click', updateOutput1);
    ...
    var save_button2 = document.querySelector('#saveText2');

    input_textarea2.value = localStorage.getItem('content2');
    saveText2.addEventListener('click', updateOutput2);
    ...
    var save_button3 = document.querySelector('#saveText3');
    
    input_textarea3.value = localStorage.getItem('content3');
    saveText3.addEventListener('click', updateOutput3);
    ...
    var save_button4 = document.querySelector('#saveText4');
 
    input_textarea4.value = localStorage.getItem('content4');
    saveText4.addEventListener('click', updateOutput4);
    ...
    var save_button5 = document.querySelector('#saveText5');
   
    input_textarea5.value = localStorage.getItem('content5');
    saveText5.addEventListener('click', updateOutput5);
    ...
    var save_button6 = document.querySelector('#saveText6');

    input_textarea6.value = localStorage.getItem('content6');
    saveText6.addEventListener('click', updateOutput6);
    ...
    var save_button7 = document.querySelector('#saveText7');
    
    input_textarea7.value = localStorage.getItem('content7');
    saveText7.addEventListener('click', updateOutput7);
    ...
    var save_button8 = document.querySelector('#saveText8');
    
    input_textarea8.value = localStorage.getItem('content8');
    saveText8.addEventListener('click', updateOutput8);
    ...
    var save_button9 = document.querySelector('#saveText9');

    input_textarea9.value = localStorage.getItem('content9');
    saveText9.addEventListener('click', updateOutput9);
